...
public class Text2WindowedVectors {

	private static Logger logger = MalletLogger.getLogger(Text2WindowedVectors.class.getName());

	static CommandOption.SpacedStrings classDirs =	new CommandOption.SpacedStrings
		(Text2WindowedVectors.class, "input", "DIR...", true, null,
	...
	static CommandOption.File outputFile = new CommandOption.File
		(Text2WindowedVectors.class, "output", "FILE", true, new File("text.vectors"),
	...
	static CommandOption.File usePipeFromVectorsFile = new CommandOption.File
		(Text2WindowedVectors.class, "use-pipe-from", "FILE", true, new File("text.vectors"),
	...
	static CommandOption.Boolean preserveCase = new CommandOption.Boolean
		(Text2WindowedVectors.class, "preserve-case", "[TRUE|FALSE]", false, false,
		 "If true, do not force all strings to lowercase.", null);

	static CommandOption.Boolean removeStopWords = new CommandOption.Boolean
		(Text2WindowedVectors.class, "remove-stopwords", "[TRUE|FALSE]", false, false,
	...
	static CommandOption.File stoplistFile = new CommandOption.File
		(Text2WindowedVectors.class, "stoplist-file", "FILE", true, null,
	...
	static CommandOption.File extraStopwordsFile = new CommandOption.File
		(Text2WindowedVectors.class, "extra-stopwords", "FILE", true, null,
	...
	static CommandOption.Boolean skipHeader = new CommandOption.Boolean
		(Text2WindowedVectors.class, "skip-header", "[TRUE|FALSE]", false, false,
	...
	static CommandOption.Boolean skipHtml = new CommandOption.Boolean
		(Text2WindowedVectors.class, "skip-html", "[TRUE|FALSE]", false, false,
	...
	static CommandOption.Boolean binaryFeatures = new CommandOption.Boolean
		(Text2WindowedVectors.class, "binary-features", "[TRUE|FALSE]", false, false,
		 "If true, features will be binary.", null);

	static CommandOption.IntegerArray gramSizes = new CommandOption.IntegerArray
		(Text2WindowedVectors.class, "gram-sizes", "INTEGER,[INTEGER,...]", true, new int[] {1},
	...
	static CommandOption.Boolean keepSequence = new CommandOption.Boolean
		(Text2WindowedVectors.class, "keep-sequence", "[TRUE|FALSE]", false, false,
	...
	static CommandOption.Boolean keepSequenceBigrams = new CommandOption.Boolean
		(Text2WindowedVectors.class, "keep-sequence-bigrams", "[TRUE|FALSE]", false, false,
	...
	static CommandOption.Boolean saveTextInSource = new CommandOption.Boolean
		(Text2WindowedVectors.class, "save-text-in-source", "[TRUE|FALSE]", false, false,
	...
	static CommandOption.ObjectFromBean stringPipe = new CommandOption.ObjectFromBean
		(Text2WindowedVectors.class, "string-pipe", "Pipe constructor",	true, null,
	...
	static CommandOption.ObjectFromBean tokenPipe = new CommandOption.ObjectFromBean
		(Text2WindowedVectors.class, "token-pipe", "Pipe constructor",	true, null,
	...
	static CommandOption.ObjectFromBean featureVectorPipe = new CommandOption.ObjectFromBean
		(Text2WindowedVectors.class, "fv-pipe", "Pipe constructor",	true, null,
	...
	static CommandOption.String encoding = new CommandOption.String
		(Text2WindowedVectors.class, "encoding", "STRING", true, Charset.defaultCharset().displayName(),
		 "Character encoding for input file", null);

	static CommandOption.String tokenRegex = new CommandOption.String
		(Text2WindowedVectors.class, "token-regex", "REGEX", true, CharSequenceLexer.LEX_ALPHA.toString(),
	...
	static CommandOption.Boolean printOutput = new CommandOption.Boolean
		(Text2WindowedVectors.class, "print-output", "[TRUE|FALSE]", false, false,
	...
	public static void main (String[] args) throws FileNotFoundException, IOException 	{
		...
		CommandOption.setSummary (Text2WindowedVectors.class,
								  "A tool for creating instance lists of FeatureVectors or FeatureSequences from text documents.\n");
		CommandOption.process (Text2WindowedVectors.class, args);
		//String[] classDirs = CommandOption.process (Text2Vectors.class, args);

		// Print some helpful messages for error cases
		if (args.length == 0) {
			CommandOption.getList(Text2WindowedVectors.class).printUsage(false);
			System.exit (-1);
		}
		...
		if (usePipeFromVectorsFile.wasInvoked()) {
			...
			TokenSequenceWithContext contextSequence = new TokenSequenceWithContext();
			pipeList.add(contextSequence);
